...
class PlanWorkoutsListAdapter(private var workoutList: List<WorkoutPlan>) :
    RecyclerView.Adapter<PlanWorkoutsListAdapter.ViewHolder>() {
    private var onClickListener: ((Int) -> Unit)? = null

    // Reference the type of views I'm using
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        // List of workout cards
        val planWorkoutsCard: Button = view.findViewById(R.id.plan_workouts_card)
        val homeWorkoutName: TextView = view.findViewById(R.id.plan_workout_name)
